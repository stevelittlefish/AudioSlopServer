...
//go:embed admin.html jobs.html test.html test-demucs.html test-stableaudio.html test-acestep.html test-yue.html test-aligner.html assets/test.css assets/test-common.js assets/logo.svg assets/logo-bars.svg
var assets embed.FS
...
func Register(mux *http.ServeMux, cfg *config.Config) {
	...
	mux.Handle("GET /jobs", page("jobs.html"))
